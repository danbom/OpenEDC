      ...
      <div class="columns is-desktop is-centered" id="details-panel">
        <div class="column">
          <div class="box has-sidebar">
            ...
            <div class="box-content" id="foundational-options">
              <div class="columns">
                <div style="width: 100%; display: flex; flex-direction: row">
                  ...
                  <div
                    class="field is-flex is-flex-direction-column is-flex-grow-1"
                  >
            ...
            <div
              class="box-content is-relative is-hidden"
              id="extended-options"
            >
              <div
                class="columns"
              ...
              >
                  ...
                  <div class="field">
                    ...
                    <div style="display: flex">
                      ...
                      <button
                        ...
                        id="add-alias-button" style="margin-left:0.5rem"
                      ...
                      ><a
                        ...
                        i18n="edit-settings"
                        onclick="showSettingsEditor()" style="margin-left:0.5rem"
                      ></a>
                    </div>
                  </div>
                </div>
                <div style="display: flex; flex-direction: row">
                  ...
                  <div class="field">
                    ...
                    <div style="display: flex"><div id="range-check-inputs"></div>
                    <button
                      class="button is-small"
                      id="add-range-check-button" style="margin-left:0.5rem"
            ...
            <div class="box-content is-hidden" id="duplicate-options" style="display:flex;flex-direction:row;">
              <div class="field">
